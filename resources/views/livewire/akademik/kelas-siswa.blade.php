<div class="page-inner">
    <div class="row">
                ...
                <div class="card-body">
                    <h4 class="card-title text-capitalize">
                        <a href="{{route('dashboard')}}">
                            <span><i class="fas fa-arrow-left mr-3"></i>kelas siswa</span>
                        </a>
        ...
        <div class="col-md-12">
            ...
            <div class="card">
                <div class="card-body">
                    <x-select name="kelas_id" label="Kelas" handleChange="handleChangeKelas">
                    ...
                    <div class="form-group">
                        <livewire:table.siswa-list-table params="{{$route_name}}" />
                    </div>
                    <div class="form-group">
