<div class="page-inner">
    <div class="row">
                ...
                <div class="card-body">
                    <h4 class="card-title text-capitalize">
                        <a href="{{route('dashboard')}}">
                            <span><i class="fas fa-arrow-left mr-3 text-capitalize"></i>tbl data akademiks</span>
                        </a>
        ...
        <div class="col-md-12">
            <livewire:table.data-akademik-table params="{{$route_name}}" />
        </div>
            ...
            <div class="modal-dialog" permission="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title text-capitalize" id="my-modal-title">{{$update_mode ? 'Update' : 'Tambah'}} tbl data akademiks</h5>
                    </div>
                    <div class="modal-body">
                        <x-select name="data_semester_id" label="Pilih Semester">
                            <option value="">Select Pilih Semester</option>
                            @foreach ($semesters as $item)
                            <option value="{{$item->id}}">{{$item->nama_semester}}</option>
                            @endforeach
                        </x-select>
                        <x-text-field type="text" name="kode_akademik" label="Kode Akademik" />
                        <x-text-field type="text" name="nama_akademik" label="Nama Akademik" />
                        <x-select name="status_akademik" label="Status Akademik">
                            <option value="">Select Status Akademik</option>
